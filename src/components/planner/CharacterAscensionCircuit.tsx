...
import { SetCharacterCostsSkill, SetCharacterCostsPassive } from "../../helpers/AscensionCostIndex"
...
const CharacterAscensionCircuit = (props: any) => {
    ...
    React.useEffect(() => {
        dispatch(updateCharacterCosts([name, "circuit", SetCharacterCostsSkill(sliderValue[0], sliderValue[1], selectedMainNode)]))
        dispatch(updateCharacterCosts([name, "circuit_node1", SetCharacterCostsPassive(1, selectedNode1)]))
        dispatch(updateCharacterCosts([name, "circuit_node2", SetCharacterCostsPassive(2, selectedNode2)]))
    })
