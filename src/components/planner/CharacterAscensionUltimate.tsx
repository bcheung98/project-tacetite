...
const CharacterAscensionUltimate = (props: any) => {
    ...
    React.useEffect(() => {
        dispatch(updateCharacterCosts([name, "ultimate", SetCharacterCostsSkill(sliderValue[0], sliderValue[1], selectedMainNode)]))
        dispatch(updateCharacterCosts([name, "ultimate_node1", SetCharacterCostsNode(1, selectedNode1)]))
        dispatch(updateCharacterCosts([name, "ultimate_node2", SetCharacterCostsNode(2, selectedNode2)]))
    })
